...
def bundle() {
  ...
  withCredentials([
    ...
    utils.nix_bundle_sh "bundle exec --gemfile=fastlane/Gemfile fastlane ios ${target}"
  }
...
def uploadToDiawi() {
  withCredentials([
    ...
    utils.nix_bundle_sh 'bundle exec --gemfile=fastlane/Gemfile fastlane ios upload_diawi'
  }
...
def uploadToSauceLabs() {
  ...
  withCredentials([
    ...
    utils.nix_bundle_sh 'bundle exec --gemfile=fastlane/Gemfile fastlane ios saucelabs'
  }
