...
in
{
  "realm-2.26.1" = nodeEnv.buildNodePackage {
    name = "realm";
    packageName = "realm";
    version = "2.26.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/realm/-/realm-2.26.1.tgz";
      sha512 = "kkDOMV5vgaPOYgTELHFPws9suEF0LI/kSb8SIZ615STKHLHLiRxioxgBcu5beO5HVkjxe5jYx7duSB3NASr+AA==";
    };
    dependencies = [
